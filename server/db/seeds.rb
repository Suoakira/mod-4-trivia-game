...
Comment.create(comment: 'test2', user_id: 2)
Comment.create(comment: 'test3', user_id: 3)
Comment.create(comment: 'test4', user_id: 4)
Comment.create(comment: 'test5', user_id: 5)
Comment.create(comment: 'test6', user_id: 6)
